...
# Logs
enclii logs coforma-studio-api --env prod -f                    # live tail
enclii logs coforma-studio-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback coforma-studio-api --env prod                   # previous release
enclii rollback coforma-studio-api v42 --env prod

# Releases + deployment history
enclii releases coforma-studio-api -n 20
...
enclii domains list --service coforma-studio-api
enclii domains add my.example.com --service coforma-studio-api   # auto-provisions tunnel route + DNS
